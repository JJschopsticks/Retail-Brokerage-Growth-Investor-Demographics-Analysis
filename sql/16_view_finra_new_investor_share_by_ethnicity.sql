...
-- s_ethnicity, to check whether the 2021->2024 decline in new-investor
-- share is uniform across ethnicity groups or concentrated in one of them.

CREATE VIEW finra_new_investor_share_by_ethnicity AS
SELECT
    wave_year,
    s_ethnicity,
...
ORDER BY wave_year, s_ethnicity;