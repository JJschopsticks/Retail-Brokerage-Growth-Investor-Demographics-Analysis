-- Same logic as finra_new_investor_share (sql/12), but segmented by s_age,
-- to check whether the 2021->2024 decline in new-investor share is uniform
-- across age groups or concentrated in one of them.

CREATE VIEW finra_new_investor_share_by_age AS
SELECT
    wave_year,
    s_age,
