...
-- s_education, to check whether the 2021->2024 decline in new-investor
-- share is uniform across education levels or concentrated in one of them.

CREATE VIEW finra_new_investor_share_by_education AS
SELECT
    wave_year,
    s_education,
...
ORDER BY wave_year, s_education;